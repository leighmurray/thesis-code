...
elapsedMillis currentMeasureInterval;
const int maxMeasureInterval = 1000;
...
void loop() {
  ...
  if (currentMeasureInterval > maxMeasureInterval){
    Serial.print(String(bytesReceived) + ",");
    bytesReceived = 0;
    currentMeasureInterval = 0;
  }
}
